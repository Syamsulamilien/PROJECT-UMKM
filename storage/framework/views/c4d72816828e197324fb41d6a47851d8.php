...
<div class="space-y-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="text-[#44318D] hover:text-[#2A1B3D]">Update Stock</a>
                            </td>
                        </tr>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-[#44318D]">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-[#44318D]"><?php echo e($totalUsers); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-[#44318D]"><?php echo e($totalOrders); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-[#44318D]"><?php echo e($totalProducts); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between border-b pb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500"><?php echo e($order->user->name); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="font-medium text-gray-900">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></p>
            ...
            <div class="mt-4">
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-[#44318D] hover:text-[#2A1B3D]">View all orders →</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baju-polos\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>