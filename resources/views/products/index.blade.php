        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-8">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center">
                        <span class="text-sm text-gray-500">Showing {{ $products->firstItem() }} - {{ $products->lastItem() }} of {{ $products->total() }} products</span>
                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            <input type="checkbox" 
                                                   ...
                                                   value="{{ $category->id }}"
                                                   class="h-4 w-4 text-[#44318D] focus:ring-[#44318D] border-gray-300 rounded">
                                            <label for="mobile-category-{{ $category->id }}" class="ml-2 text-sm text-gray-600">
                                                {{ $category->name }}
                                            </label>
                                        </div>
                                        @endforeach
