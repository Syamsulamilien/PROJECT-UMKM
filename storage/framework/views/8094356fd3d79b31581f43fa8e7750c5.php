...
<section class="relative bg-primary-500 py-20">
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/hero-bg.jpg')); ?>" alt="Background" class="w-full h-full object-cover opacity-20">
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="<?php echo e(asset($product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-64 object-cover">
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-primary-500"><?php echo e($product->name); ?></h3>
                    <p class="text-gray-600 mt-2"><?php echo e($product->category->name); ?></p>
                    <p class="text-secondary-500 font-bold mt-2">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
               ...
               class="group relative h-64 overflow-hidden rounded-lg">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition duration-300">
                    <div class="flex h-full items-center justify-center">
                        <h3 class="text-2xl font-bold text-white"><?php echo e($category->name); ?></h3>
                    </div>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baju-polos\resources\views/home.blade.php ENDPATH**/ ?>